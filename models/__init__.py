...
def backbone(backbone_name):
    ...
    """
    if 'resnetattributesboost' in backbone_name:
        from .resnet_attributes_boost import ResNetBackbone as b
    elif 'resnetattributes' in backbone_name:
        from .resnet_attributes import ResNetBackbone as b
