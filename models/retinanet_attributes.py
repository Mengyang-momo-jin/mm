...
def default_submodels(num_classes, num_anchors, num_attributes):
    ...
    return [
        ...
        ('attributes', default_attributes_model(num_attributes, num_anchors))
    ]
...
def retinanet(
    ...
    if submodels is None:
        submodels = default_submodels(num_classes, num_anchors, num_attributes)
        #submodels = build_submodels(num_classes=num_classes, num_attributes=num_attributes, num_anchors=num_anchors)
    #name, model = submodels[2]  # Get attributes submodel
