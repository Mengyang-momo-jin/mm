...
from ..models.retinanet_attributes import retinanet_bbox
...
def parse_args(args):
    ...
    parser.add_argument('--backbone', help='Backbone model used by retinanet.', default='resnetattributes50', type=str)
