...
from ..models.retinanet_attributes_boost import retinanet_bbox
from ..preprocessing.csv_generator import CSVGenerator
from ..preprocessing.kitti import KittiGenerator
from ..preprocessing.open_images import OpenImagesGenerator
from ..preprocessing.pascal_voc_attributes import PascalVocGenerator
from ..utils.anchors_attributes import make_shapes_callback, anchor_targets_bbox
...
def create_models(backbone_retinanet, num_classes, weights, multi_gpu=0, freeze_backbone=False, num_attributes=None):
    ...
    if num_attributes is None:
        ...
        if multi_gpu > 1:
            with tf.device('/cpu:0'):
                model = model_with_weights(backbone_retinanet(num_classes, num_attributes, modifier=modifier),
...
def parse_args(args):
    ...
    parser.add_argument('--backbone', help='Backbone model used by retinanet.', default='resnetattributesboost50', type=str)
